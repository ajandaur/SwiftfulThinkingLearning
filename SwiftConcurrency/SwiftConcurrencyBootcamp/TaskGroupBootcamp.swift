//
//  TaskViewBootcamp.swift
//  SwiftConcurrencyBootcamp
//
//  Created by Anmol  Jandaur on 9/19/22.
//
...
class TaskGroupBootcampDataManager {
    ...
    func fetchImagesWithTaskGroup() async throws -> [UIImage] {
        ...
        return try await withThrowingTaskGroup(of: UIImage.self) { group in
            ...
            // This for-loop will wait for each of these tasks to come back..
            // if one never returned back, it would be waiting or until it fails
...
struct TaskViewBootcamp_Previews: PreviewProvider {
