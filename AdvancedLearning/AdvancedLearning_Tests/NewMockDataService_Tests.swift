...
//
//  Created by Anmol  Jandaur on 4/3/23.
//
...
final class NewMockDataService_Tests: XCTestCase {
    ...
    func test_NewMockDataService_downItemsWithEscaping_doesReturnValues() {
        // Given
    ...
    func test_NewMockDataService_downItemsWithEscaping_doesFail() {
        // Given
