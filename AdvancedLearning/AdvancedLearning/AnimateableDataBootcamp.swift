...
struct RectangleWithSingleCornerAnimation: Shape {
    ...
    var animatableData: CGFloat {
        ...
        set {
            // set the value of the cornerRadius
...
struct Pacman: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        Path { path in
            ...
            path.addArc(center: CGPoint(x: rect.midX, y: rect.minY), radius: rect.height / 2, startAngle: Angle(degrees: 20), endAngle: Angle(degrees: 360 - offsetAmount), clockwise: false)
        }
    }
}
